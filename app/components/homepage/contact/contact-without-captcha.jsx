...
const handleSendMail1 = async (e) => {
  ...
  return (
    <div className="">
      ...
      <div className="max-w-3xl text-white rounded-lg border border-[#c89147] p-3 lg:p-5">
        ...
        <div className="mt-6 flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <input
              className="bg-[#10172d] w-full border rounded-md border-[#c89147] focus:border-[#c89147] ring-0 outline-0 transition-all duration-300 px-3 py-2"
              type="text"
              maxLength="100"
              required={true}
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <button
              className="flex items-center gap-1 hover:gap-3 rounded-full bg-gradient-to-r from-pink-500 to-[#000] px-5 md:px-12 py-2.5 md:py-3 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline transition-all duration-200 ease-out hover:text-white hover:no-underline md:font-semibold"
              role="button"
